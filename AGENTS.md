...
- **UI:** pixel-perfect against `.design-source/laravel-flow-admin/project/`. Dark default. Density high. Border radius ≤ 8px. No nested cards. Every icon-only button needs `aria-label` + tooltip.
