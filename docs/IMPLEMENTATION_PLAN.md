...
- **DET**:
  ...
  - La skill **`flow-admin-blade-component`** (convenzione partials/icons/Alpine) sarà creata in Macro 3 una volta che la struttura definitiva dei componenti Blade è stabilita; non appartiene a Macro 1 che è solo scaffold.
- **GR**:
